...
<style>
	...
	function fileDelete(obj, qfNo, rName){
		$.ajax({
			url : '${pageContext.request.contextPath}/qboard/fileDelete.do',
			data : { qfNo : qfNo, rName : rName }, 
			dataType : 'json',
...
<div id="container">
      ...
      <c:import url="../common/header.jsp"/>
		<div id="board-container">
			<form name="boardFrm" action="${pageContext.request.contextPath}/qboard/qboardUpdate.do" method="post" onsubmit="return validate();" enctype="multipart/form-data">
				...
				<input type="button" class="btn btn-outline-danger" value="삭제" onclick="location.href='${pageContext.request.contextPath}/qboard/qboardDelete.do?qNo=${qboard.qNo}'"/>
			</form>
		</div>
