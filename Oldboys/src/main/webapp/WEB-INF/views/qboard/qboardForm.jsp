	 ...
	 <div id="wrapper">
      <c:import url="../common/header.jsp"/>
		...
		<img src="${pageContext.request.contextPath}/resources/img/smerp2.png" />
			<form name="boardFrm" action="${pageContext.request.contextPath}/qboard/qboardFormEnd.do" method="post" onsubmit="return validate();" enctype="multipart/form-data">
				<input type="text" class="form-control" placeholder="제목" name="qTitle" id="qTitle" required>
				<input type="text" class="form-control" name="qWriter" value="${member.userId}" readonly required>
