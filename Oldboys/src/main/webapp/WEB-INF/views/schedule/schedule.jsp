		...
		<form action="scheduleUpdate.do">
			...
			<div class="modal fade" tabindex="-1" role="dialog" id="updateModal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">일정 내용 및 수정</h4>
							<button type="button" class="close" data-dismiss="modal"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						...
						<!-- <div class="row">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-xs-4" for="edit-title">&nbsp;일정명</label> <input
											class="inputModal" type="text" name="_title" id="_title"
											required="required" size="40" />
									</div>
								</div>
							</div>
							...
							<div class='col-xs-12'>
								<div class="form-group">
									<div class="input-group date" id="datetimepicker9"
										...
										<label class="col-xs-4" for="edit-start">시작</label>
										&nbsp;&nbsp;&nbsp; <input type="text"
											class="datetimepicker-input" data-target="#datetimepicker9"
											name="_startDate" id="_startDate" size="40" />
							...
							<div class='col-xs-12'>
								<div class="form-group">
									<div class="input-group date" id="datetimepicker10"
										...
										<label class="col-xs-4" for="edit-end" style="float: auto;">&nbsp;&nbsp;끝</label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
											class="datetimepicker-input" data-target="#datetimepicker10"
											name="_endDate" id="_endDate" size="40" />
										<div class="input-group-append"
											data-target="#datetimepicker10" data-toggle="datetimepicker">
											<div class="input-group-text">
												<i class="fa fa-calendar"></i>
											</div>
										</div>
		     ...
		     eventClick:function(event) {
		    	 ...
		    	 $.ajax({
		    		 ...
		    		 success : function(data){
		    			 ...
		    			 $('#_edit-allDay').val(data.schedule.allDay);
		    			 ...
		    			 $('#_edit-color').css('color', $('#_edit-color').val());
