              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><h5>매입</h5> 
                        <a href="#">(자세히 보러가기)</a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><h5>매출</h5>
                        <a href="#" style="color:#1cc88a!important;">(자세히 보러가기)</a>
                      </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><h5>매입/매출 비율 </h5>
                      </div>
                      <p style="color:#36b9cc!important; font-size:.7rem; margin-top:8px;"><B>(매입 퍼센트)</B></p>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><h5>이달의 순이익</h5>
                        <p style="font-size:7px;">(이달의 순이익)</p>
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$200,200</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">전문가의 조언 - [ 매입편 ]</h6>
                </div>
                <div class="card-body">
                  ...
                  그에 대한 조언으로 일주일치 분으로 구매를 하시길 희망합니다.</P>
                  &nbsp; &nbsp; &rarr; &nbsp; <a href="#"> 보다 전문적인 조언을 듣고 싶으시다면 클릭해주세요.</a>
                </div>
              </div>
              </div>
            <div class="col-lg-6 mb-4">  
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">전문가의 조언 - [ 매출편 ]</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="resources/img/undraw_posting_photo.svg" alt="">
                  ...
                  <p>이달의 매출은 상당히 좋습니다. <br />이 페이스를 유지하여 관리하시면 될 것 같습니다.</p>
                   	&nbsp; &nbsp; &rarr; &nbsp; <a target="_blank" rel="nofollow" href="https://undraw.co/"> 보다 전문적인 조언을 듣고 싶으시다면 클릭해주세요.</a>
                </div>
              </div>
              </div>
          </div>
